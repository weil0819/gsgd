...
plot 'data/eval-V.dat' using ($2)/1000000:xticlabels(1) title "CLUSTER", \
...
plot 'data/eval-V.dat' using ($5)/1000000:xticlabels(1) title "CLUSTER", \
...
plot 'data/eval-V.dat' using ($8)/1000000:xticlabels(1) title "CLUSTER", \
...
plot 'data/eval-V.dat' using ($11)/1000000:xticlabels(1) title "CLUSTER", \
